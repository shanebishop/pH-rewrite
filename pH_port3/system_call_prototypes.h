...
struct jprobe jprobes_array[] = {
	...
	*/
	...
	/* // Problem with this group of syscalls
	{
		.entry = jsys_shmat,
		.kp = {
	...
	*/
	...
	/* // These two syscalls have been confirmed to have issues
	{
		.entry = jsys_sysctl,
		.kp = {
	...
	*/
	...
	/* // Problem with this set of syscalls
	{
		.entry = jsys_sysfs,
		.kp = {
	...
	*/
	...
	/* // There is a problem with this set of syscalls
	{
	...
	*/
	...
	/* // This syscall has been determined to cause issues for some reason
	{
		.entry = jsys_statx,
		.kp = {
